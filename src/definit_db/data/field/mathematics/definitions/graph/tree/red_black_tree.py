...
used to represent the {NODE.key.get_reference(phrase="nodes")}. The tree maintains certain properties to ensure 
...
{LEAF.key.get_reference(phrase="leaves")} are black. 4. If a red node has children, then both children are black. 
