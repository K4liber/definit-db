...
_definition_keys: tuple[DefinitionKey, ...] = (
    ...
    UPPER_BOUND.key,
    TURING_MACHINE.key,
    DETERMINISTIC_TURING_MACHINE.key,
    NONDETERMINISTIC_TURING_MACHINE.key,
    BINARY_REPRESENTATION.key,
    BITWISE_OPERATION.key,
    ARITHMETIC_RIGHT_SHIFT.key,
    LOGICAL_RIGHT_SHIFT.key,
    RIGHT_SHIFT.key,
    TWOS_COMPLEMENT.key,
    CONCURRENCY.key,
    CORE.key,
